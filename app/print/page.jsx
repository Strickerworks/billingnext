...
export default function FetchInvoice() {
  ...
  const generatePDF = (fetchedData) => {
    ...
    const additionalRows = additional_charges
      .map(
        (item) => `
        <tr>
  ...
  return (
    <div className="min-h-screen bg-gray-50 text-gray-900 p-6 flex flex-col items-center space-y-8">
      <div className="text-center space-y-2">
        <h1 className="text-3xl font-bold tracking-wide text-indigo-700">📥 Download Invoice</h1>
        <p className="text-gray-500 text-sm">Enter an invoice number to directly download the PDF.</p>
      </div>
      ...
      <div className="text-gray-400 text-xs pt-8">© 2025 The Heritage Travels Billing System</div>
    </div>
  );
}
